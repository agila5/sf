...
* support  `POLYGON FULL` simple feature geometry, representing the entire Earth surface, as used by `s2geometry`. See https://r-spatial.org/r/2024/10/11/polygonfull.html for a longer introduction; #2441
